...
from ..lib.utils.temporal_optimization import create_OneEuroFilter, temporal_optimize_result
...
class Webcam_processor(Predictor):
    def __init__(self, **kwargs):
        ...
        if self.character == 'nvxia':
            ...
            from ..lib.models.nvxia import create_nvxia_model
    ...
    def webcam_run_remote(self):
        print('run on remote')
        from ..lib.utils.remote_server_utils import Server_port_receiver
